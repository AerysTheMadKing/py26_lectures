# Множественная Наследование - Это когда класс наследуется от двух или более классов
...
# a = Test()
# print(Test.mro())
# print(dir(a))  #Магические методы (дандр методы)
...
# ------------------ 
# 
# Порблема Перекростного Наследования 
