...
#Единый формат, хранения и передачи данных между приложениями, сайтами, сервисами и языками програмирования через сеть интернет.
...
# json.dumps -> метод записывает Python данные в строку в формате JSON, параллельно сделав сериализацию.


# Десериализации - это (Чтение данных в JSON)- это процесс перевода из JSONa в Python dict.

# json.load -> метод который считывает файл в формате JSON переводит его в Python object.

# json.loads -> метод который считывает текст в формате JSON переводит его в Python object.
